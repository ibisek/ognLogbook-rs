...
pub fn get_groundspeed_threshold(aircraft_type: &AircraftType, for_event: char) -> f64 {
    if for_event == 'L' {
        if vec![AircraftType::Glider, AircraftType::Helicopter, AircraftType::Parachute, AircraftType::HangGlider, AircraftType::Paraglider, AircraftType::Baloon, AircraftType::Airship, AircraftType::Uav].contains(aircraft_type) {
